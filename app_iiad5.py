...
def plotly_layout_base():
    """Layout Plotly con tema oscuro forzado — consistente con el CSS de la app.
    st.get_option('theme.base') no es confiable en Streamlit Cloud cuando el
    tema se define vía CSS inyectado; por eso forzamos siempre modo oscuro.
    """
    bg      = "rgba(0,0,0,0)"        # transparente — hereda el fondo del contenedor
    plot_bg = "rgba(26,30,46,0.85)"  # azul-oscuro semi-transparente
    font_c  = "#E8EDF3"
