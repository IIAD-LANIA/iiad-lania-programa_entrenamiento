...
# Versión 2.6 | Almacenamiento: JSON en repositorio GitHub
# Desarrollado para cumplimiento ISO 17034 & ISO 17043
# Estilo visual: alineado con Dashboard-SG-IDI_V4
# NUEVO v2.6: corrección compatibilidad modo oscuro navegador
# =============================================================================
...
def inject_css():
    ...
    /* ── ALERTAS: fondo claro + texto oscuro forzado (compatible modo oscuro) ── */
    .alerta-roja {{
        background: #FFF0F0;
...
def pagina_analisis_rol():
    ...
    if not df_res.empty:
        ...
        fig.update_layout(
            ...
            yaxis=dict(color="#888888", gridcolor="rgba(128,128,128,0.2)"),
            legend=dict(font=dict(color="#888888"))
        )
        st.plotly_chart(fig, use_container_width=True)
...
def pagina_cronograma():
    ...
    fig.update_layout(
        ...
        xaxis=dict(color="#888888", gridcolor="rgba(128,128,128,0.2)"),
        yaxis=dict(color="#888888", gridcolor="rgba(128,128,128,0.2)"),
        coloraxis_colorbar=dict(tickfont=dict(color="#888888"), title=dict(font=dict(color="#888888")))
    )
    st.plotly_chart(fig, use_container_width=True)
